    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="menusidebar">
                ...
                @canany(['instansi', 'aplikasi', 'pimpinan', 'lihat user', 'reset nomor', 'referensi', 'audit log'])
                <li class="menu menu-heading">
                    <div class="heading">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                ...
                @endcanany
                @canany(['referensi'])
                <li class="menu {{ request()->routeIs(['referensi.index']) ? 'active' : '' }}">
                    <a href="{{ route('referensi.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                @endcanany
                @canany(['audit log'])
                <li class="menu {{ request()->routeIs(['audit', 'audit.ssr']) ? 'active' : '' }}">
                    <a href="{{ route('audit') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                @role('administrator')
                <li class="menu {{ request()->routeIs(['migration.*']) ? 'active' : '' }}">
                    <a href="{{ route('migration.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="feather"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                            <span>Migrasi Legacy</span>
                        </div>
                    </a>
                </li>
                @endrole
