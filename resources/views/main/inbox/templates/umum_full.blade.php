            ...
            <tr>
                <td style="height: auto; width: 72.5mm;" class="v-top tb-wrap">
                    <div style="height: auto; margin-left: 3mm;">
                        ...
                        <label style="display: inline-block; vertical-align: top; width: 46mm; margin-top: 0.75mm;">{{ $data->dari }}</label>
                    </div>
                    <div style="height: auto; margin-left: 3mm;">
                        ...
                        <label style="display: inline-block; vertical-align: top; width: 46mm;">{{ $data->no_surat }}</label>
                    </div>
                    <div style="height: auto; margin-left: 3mm;">
                        ...
                        <label style="display: inline-block; vertical-align: bottom; width: 46mm;">{{ date_format(date_create($data->tgl_surat), 'd-m-Y') }}</label>
                    </div>
                </td>
