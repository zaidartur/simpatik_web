...
<div class="">
    <div style="">
        ...
        <table style="width: 167.5mm; margin-left: 21mm; margin-right: 27mm;" class="tb-fix">
            <tr>
            ...
            <tr>
                <td style="height: 30mm; width: 75mm;" class="v-top tb-wrap">
                    <div style="height: 15mm; margin-left: 3mm;">
                        ...
                        <label style="display: inline-block; vertical-align: top; width: 48mm; margin-top: 0.75mm;">{{ $data->dari }}</label>
                    </div>
                    <div style="height: 7mm; margin-left: 3mm;">
                        ...
                        <label style="display: inline-block; vertical-align: top; width: 48mm;">{{ $data->no_surat }}</label>
                    </div>
                    <div style="height: 8mm; margin-left: 3mm;">
                        ...
                        <label style="display: inline-block; vertical-align: bottom; width: 48mm;">{{ date_format(date_create($data->tgl_surat), 'd-m-Y') }}</label>
                    </div>
                </td>
                <td style="width: 92.5mm;" class="v-top tb-wrap">
            ...
            <tr>
                <td style="height: 34mm;" colspan="2" class="tb-wrap">
                    ...
                    <label>: </label>
                    <label style="display: inline-block; width: 144mm; vertical-align: bottom; margin-left: 3mm;">{{ $data->isi_surat }}</label>
                </td>
            </tr>
            <tr>
                {{-- <td style="height: 44mm; width: 75mm;" class="v-top tb-wrap">
            ...
            <tr>
                <td style="height: 51mm; border-right: none;" class="v-top tb-wrap">
                    <label style="display: inline-block; width: 20mm; vertical-align: middle; margin-left: 3mm; margin-top: 5mm;">Catatan</label>
                    <label>: </label>
                    <label style="display: inline-block; width: auto; vertical-align: middle; margin-left: 3mm; margin-top: 5mm;">{!! $data->disposisi[0]->penerima->level == 7 ? '&quot;'. $data->disposisi[0]->catatan_disposisi .'&quot;' : '' !!}</label>
                </td>
                <td style="height: 51mm; border-left: none;" class="v-top tb-wrap">
