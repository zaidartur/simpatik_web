...
@section('css')
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('templates/plugins/css/dark/table/datatable/dt-global_style.css') }}">
                    ...
                    <div class="widget-content widget-content-area br-8 p-3">
                        <div class="row g-2 align-items-end">
                            <div class="col-md-3">
                                ...
                                <input id="rangeCalendar" class="form-control form-control-sm flatpickr" type="text"
                            ...
                            <div class="col-md-2 d-flex gap-1">
                                <button type="button" class="btn btn-primary btn-sm w-auto" onclick="applyFilter()">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <pre id="logOldValues" class="p-2 bg-light text-dark rounded small"
                                style="max-height: 250px; overflow-y: auto;"></pre>
                        </div>
                        <div class="col-md-6 mb-3">
                            <h6 class="fw-bold text-success">Nilai Baru (Sesudah):</h6>
                            <pre id="logNewValues" class="p-2 bg-light text-dark rounded small"
                                style="max-height: 250px; overflow-y: auto;"></pre>
                        </div>
                    </div>
                </div>
