...
<head>
    ...
    <title>Contact Profile | EQUATION - Multipurpose Bootstrap Dashboard Template </title>
    ...
    <link href="{{ asset('templates/assets/css/light/apps/contacts.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('templates/assets/css/dark/components/modal.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('templates/assets/css/dark/apps/contacts.css') }}" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <script src="{{ asset('templates/assets/js/apps/contact.js') }}"></script>
</body>
</html>